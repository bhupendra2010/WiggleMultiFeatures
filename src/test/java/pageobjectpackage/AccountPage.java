...
public class AccountPage extends DriverFactory {
    public void Accountcreation(){
        ...
        driver.findElement(By.id("DualRegisterEmailModel_Email")).sendKeys("bhupendra2010@hotmail.com");
        driver.findElement(By.id("qa-dual-register")).click();

        driver.findElement(By.id("RegisterModel_EmailConfirm")).sendKeys("bhupendra2010@hotmail.com");
